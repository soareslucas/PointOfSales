              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex border-bottom pb-3">
                    <img src="static/images/faces/face1.jpg" alt="profile" class="img-xs rounded-circle"/>
                  ...
                  <div class="d-flex border-bottom py-3">
                    <img src="static/images/faces/face2.jpg" alt="profile" class="img-xs rounded-circle"/>
                    <div class="flex-grow-1 ml-3">
                      <p>Lillie Long</p>
                      <div class="d-flex text-muted">
                  ...
                  <div class="d-flex border-bottom py-3">
                    <img src="static/images/faces/face3.jpg" alt="profile" class="img-xs rounded-circle"/>
                    <div class="flex-grow-1 ml-3">
                      <p>Lloyd Harper</p>
                      <div class="d-flex text-muted">
                  ...
                  <div class="d-flex pt-3">
                    <img src="static/images/faces/face4.jpg" alt="profile" class="img-xs rounded-circle"/>
                    <div class="flex-grow-1 ml-3">
                      <p>Bradley Foster</p>
                      <div class="d-flex text-muted">
